...
//====================================================================================//
document.getElementById("inputSubTitle").addEventListener("input", function() {
    var subtitleValue = document.getElementById("inputSubTitle").value;
    document.getElementsByName("hiddeninputSubTitle")[0].value = subtitleValue;
});

document.getElementById("inputDes").addEventListener("input", function() {
    var descriptionValue = this.value;
    document.getElementById("hiddeninputDes").value = descriptionValue;
});

document.getElementById("inputContext").addEventListener("input", function() {
    var subtitleValue = document.getElementById("inputContext").value;
    document.getElementsByName("hiddeninputContext")[0].value = subtitleValue;
});

document.getElementById("inputTitle").addEventListener("input", function() {
    var subtitleValue = document.getElementById("inputTitle").value;
    document.getElementsByName("hiddeninputTitle")[0].value = subtitleValue;
});

document.getElementById("upLoadTime").addEventListener("input", function() {
    var subtitleValue = document.getElementById("upLoadTime").value;
    document.getElementsByName("hiddenupLoadTime")[0].value = subtitleValue;
});

document.getElementById("RemoveTime").addEventListener("input", function() {
    var subtitleValue = document.getElementById("RemoveTime").value;
    document.getElementsByName("hiddenRemoveTime")[0].value = subtitleValue;
});
