...
function showTable(step) {
    document.getElementById('table1').style.display = step === 1 ? 'table' : 'none';
    document.getElementById('table2').style.display = step === 2 ? 'table' : 'none';
    document.getElementById('table3').style.display = step === 3 ? 'table' : 'none';
}
