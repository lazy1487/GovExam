...
def backExamRegister():
    ...
    return importPackage.render_template('後台網頁/back_02_Registration _Management/back_01_ExamStudent_Register/back_ExamStyleSort.html',result=result,Handler=PublicUseBackName,DateTime=formatted_time)
