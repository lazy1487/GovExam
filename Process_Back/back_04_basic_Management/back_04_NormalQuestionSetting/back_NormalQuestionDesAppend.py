...
back_NormalQuestionDesAppend = importPackage.Blueprint('back_NormalQuestionDesAppend', __name__)
...
def backNormalQuestionDesAppend():
    ...
    return importPackage.render_template('後台網頁/back_04_basic_Management/back_04_NormalQuestionSetting/back_NormalQuestionDesAppend.html',result=result,Handler=user,DateTime=formatted_time)
